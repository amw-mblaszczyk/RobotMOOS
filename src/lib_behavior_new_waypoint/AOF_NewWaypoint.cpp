...
AOF_NewWaypoint::AOF_NewWaypoint(IvPDomain g_domain) 
  : AOF(g_domain)
{
...
bool AOF_NewWaypoint::setParam(const string& param, double param_val)
{
  if(param == "osy") {
    m_osy = param_val;
    m_osy_set = true;
...
bool AOF_NewWaypoint::initialize()
{
...
double AOF_NewWaypoint::evalBox(const IvPBox *b) const
{
  double eval_crs = 0;
  double eval_spd = 0;
